...
<g-emoji class="g-emoji" alias="email" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4e7.png">📧</g-emoji>  How to reach me: <a href="mailto:sayhitorainmaker@gmail.com">sayhitorainmaker@gmail.com</a>.<br>
<g-emoji class="g-emoji" alias="zap" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/26a1.png">⚡</g-emoji>  Fun fact: I co-founded my country's first ever and largest digital marketing agency Analyzen.</p>

### things I code with:
<img src="./images/js.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/react.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/express.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/mongo.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/node.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/sass.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/vs.svg" style="max-width: 100%; margin-right: 10px;" >
<img src="./images/git.svg" style="max-width: 100%; margin-right: 10px;" >
